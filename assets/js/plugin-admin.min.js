        ...
        ! function () {
            if (t(".mrpacket #dataTable").length > 0) {
                var e = {
                        dom: "Blfrtip",
                        language: {
                            url: MRPacketForWordpressParamsAdmin.mrpacket_json_url
                        },
                        stateSave: !0,
                        columnDefs: [{
                            targets: 0,
                    ...
                    o = t(".mrpacket #dataTable").DataTable(e);
                ...
                o.order([
                    ...
                    if (e.count()) {
                        ...
                        t.each(e, function (e, t) {
                            ...
                            method: "POST",
                            url: MRPacketForWordpressParamsAdmin.mrpacket_ajax_url,
                            data: {
                    ...
                    } else alert("Please select the entries to be deleted first!")
                    ...
                    if (e.count()) {
                        ...
                        t.each(e, function (e, t) {
                            ...
                            console.log(e), alert("Error: The requested operation could not be carried out. Please contact mrpacket support. " + e)
                        })
                    } else alert("Please select the entries to be updated first!")
                    ...
                    } else alert("Please select the entries to be archived first!")
                })
            }
            ...
            if (13 == t.keyCode) return e(".woocommerce-save-button").click(), !1
        })
    })
}();